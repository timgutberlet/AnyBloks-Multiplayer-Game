...
public enum PacketType {
  ...
  GAME_START_PACKET, GAME_WIN_PACKET, ILLEGAL_TURN_PACKET, INIT_GAME_PACKET, CHECK_CONNECTION_PACKET,
  PLAYER_LIST_PACKET, RESTFUL_LOGIN_PACKET, DELETE_ACCOUNT_REQUEST_PACKET, HOST_QUIT_PACKET,
  PLAYER_QUIT_PACKET, LOBBY_SCORE_BOARD_PACKET
