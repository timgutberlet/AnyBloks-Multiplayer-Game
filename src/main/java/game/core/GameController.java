...
/**
 * Gamecontroller Class, extending the Abstractgamecontroller,
 * that sets the Scene and Stage of the Ui and controls,
 * what controller is shown in the UI. It also controls relevant
 * Server threads.
 *
 * @author tgutberl
 */
public class GameController extends AbstractGameController {
  ...
  /**
   * Gamecontroller Constructor, initializing the stage and application
   * and starting relevant Server threads.
   *
