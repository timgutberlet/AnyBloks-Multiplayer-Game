...
/**
 * tests the game mode junior with all ai types.
 * @author tiotto
 * @date 17.05.2022
 */
class AiGamemodeJuniorTest {
  ...
  static void preparation(){
    ...
    Game game1 = gameSession1.startGame(new GameModeJunior());
    ...
    Game game2 = gameSession2.startGame(new GameModeJunior());
